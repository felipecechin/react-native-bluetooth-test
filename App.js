...
export default class App extends Component<{}> {
    ...
    componentDidMount() {
        ...
        BluetoothSerial.on('bluetoothEnabled', () => {
            ...
            BluetoothSerial.on('error', (err) => ToastAndroid.show(err.message, ToastAndroid.SHORT));
    ...
    connect(device) {
        ...
        BluetoothSerial.connect(device.id)
            ...
            .catch((err) => ToastAndroid.show(err.message + ' ' + device.name, ToastAndroid.SHORT));
    }
            ...
            BluetoothSerial.discoverUnpairedDevices()
                .then((unpairedDevices) => {
                    ...
                    if (uniqueDevices.length > 0) {
                        ...
                        ToastAndroid.show('Nenhum dispositivo escaneado', ToastAndroid.SHORT);
                    }
    ...
    toggleSwitch() {
        BluetoothSerial.write(this.state.command)
            .then((res) => {
                ToastAndroid.show('Resposta: ' + res, ToastAndroid.SHORT);
                ToastAndroid.show('Enviado: ' + this.state.command, ToastAndroid.SHORT);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <View>
                    <View>
                        <Button title={'Enviar bytes'} onPress={this.sendBytes.bind(this)}/>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                        <TextInput style={{flex: 8}} onChangeText={text => this.setState({command: text})}
                                   value={this.state.command} placeholder={'Digite aqui o comando'}/>
                        <Button
                            style={{flex: 2}}
